...
export default function ResponsiveHero() {
  ...
  const translations = {
    it: {
      ...
      subtitle: "Lo Studio Legale Amaranto offre consulenza e assistenza legale in ambito civile, penale e amministrativo militare.",
    ...
    en: {
      ...
      subtitle: "Studio Legale Amaranto offers legal advice and assistance in civil, criminal and military administrative law.",
